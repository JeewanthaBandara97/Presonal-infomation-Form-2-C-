...
namespace lOG {
    ...
    public partial class AppData : global::System.Data.DataSet {
        ...
        public partial class EmpDataTable : global::System.Data.TypedTableBase<EmpRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public EmpRow AddEmpRow(string Full_Name, string Phone_Number, string Email, string Address, string Image) {
        ...
        public partial class EmpRow : global::System.Data.DataRow {
            ...
            public string Image {
                get {
                    try {
                        return ((string)(this[this.tableEmp.ImageColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace lOG.AppDataTableAdapters {
    ...
    public partial class EmpTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Emp` (`Full Name`, `Phone Number`, `Email`, `Address`) VALUES (?, ?," +
                " ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Emp` SET `Full Name` = ?, `Phone Number` = ?, `Email` = ?, `Address` = ? WHERE ((`ID Number` = ?) AND ((? = 1 AND `Full Name` IS NULL) OR (`Full Name` = ?)) AND ((? = 1 AND `Phone Number` IS NULL) OR (`Phone Number` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)) AND ((? = 1 AND `Address` IS NULL) OR (`Address` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::lOG.Properties.Settings.Default.PDatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT [ID Number], [Full Name], [Phone Number], Email, Address FROM Emp";
        ...
        public virtual int Insert(string Full_Name, string Phone_Number, string Email, string Address) {
            if ((Full_Name == null)) {
        ...
        public virtual int Update(string Full_Name, string Phone_Number, string Email, string Address, int Original_ID_Number, string Original_Full_Name, string Original_Phone_Number, string Original_Email, string Original_Address) {
            if ((Full_Name == null)) {
